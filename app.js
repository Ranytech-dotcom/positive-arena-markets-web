...
function renderHero(s){
  ...
  if(!s||String(s.asset||'').toUpperCase()!=='XAUUSD'){
    e.innerHTML='<div class="ey">CURRENT GOLD SIGNAL</div><div class="empty"><b>No active Gold setup right now.</b><br><span>V6 is monitoring XAUUSD and will display a setup only after the required checks pass.</span></div>';
    return;
  }
